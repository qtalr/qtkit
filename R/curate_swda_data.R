#' Curate SWDA data
#'
#' Process and curate Switchboard Dialog Act (SWDA) data by reading all .utt files
#' from a specified directory and converting them into a structured format.
#'
#' @param dir_path Character string. Path to the directory containing .utt files.
#'
